...
namespace FileHashCraft.ViewModels
{
    ...
    public class MainWindowViewModel : ObservableObject, IMainWindowViewModel
    {
        ...
        private void LoadSettings()
        {
            if (File.Exists(settingsFilePath))
            {
                ...
                if (root != null)
                {
                    ...
                    HashAlgorithm = root.Element("HashAlgorithm")?.Value ?? HashAlgorithmHelper.GetHashAlgorithmName(Models.FileHashAlgorithm.SHA256);
        ...
        /// ハッシュ計算アルゴリズムの変更
        /// </summary>
        private string _HashAlgorithm = HashAlgorithmHelper.GetHashAlgorithmName(Models.FileHashAlgorithm.SHA256);
